...
For more info: [Codex](http://codex.wordpress.org/Class_Reference/WP_Query), [Source code](https://github.com/wordpress/wordpress/blob/master/wp-includes/query.php).
